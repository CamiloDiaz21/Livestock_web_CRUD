...
type Identificacion struct {
	...
	IdIdentificacionUsuarioVendedor *UsuarioVendedor `orm:"column(id_identificacion_usuario_vendedor);rel(fk)"`
	IdIdentificacionUsuarioComun    *UsuarioComun    `orm:"column(id_identificacion_usuario_comun);rel(fk)"`
