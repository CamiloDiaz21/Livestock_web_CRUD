...
// TipoUsuarioController operations for TipoUsuario
type TipoUsuarioController struct {
	beego.Controller
}

// URLMapping ...
func (c *TipoUsuarioController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create TipoUsuario
// @Param	body		body 	models.TipoUsuario	true		"body for TipoUsuario content"
// @Success 201 {int} models.TipoUsuario
// @Failure 403 body is empty
// @router / [post]
func (c *TipoUsuarioController) Post() {
	var v models.TipoUsuario
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoUsuario(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get TipoUsuario by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.TipoUsuario
// @Failure 403 :id is empty
// @router /:id [get]
func (c *TipoUsuarioController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTipoUsuarioById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
...
func (c *TipoUsuarioController) GetAll() {
	...
	l, err := models.GetAllTipoUsuario(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
...
// Put ...
// @Title Put
// @Description update the TipoUsuario
...
// Delete ...
// @Title Delete
// @Description delete the TipoUsuario
