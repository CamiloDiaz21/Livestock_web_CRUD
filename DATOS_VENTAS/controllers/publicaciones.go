...
// PublicacionesController operations for Publicaciones
type PublicacionesController struct {
	beego.Controller
}

// URLMapping ...
func (c *PublicacionesController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create Publicaciones
// @Param	body		body 	models.Publicaciones	true		"body for Publicaciones content"
// @Success 201 {int} models.Publicaciones
...
// GetOne ...
// @Title Get One
// @Description get Publicaciones by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Publicaciones
...
// @Failure 403
// @router / [get]
func (c *PublicacionesController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllPublicaciones(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
...
// Put ...
// @Title Put
// @Description update the Publicaciones
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Publicaciones	true		"body for Publicaciones content"
// @Success 200 {object} models.Publicaciones
// @Failure 403 :id is not int
// @router /:id [put]
func (c *PublicacionesController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Publicaciones{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdatePublicacionesById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the Publicaciones
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *PublicacionesController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeletePublicaciones(id); err == nil {
